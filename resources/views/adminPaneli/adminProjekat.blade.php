...
@section('sidebar')
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link" href="">Dodaj novi projekat</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="">Spisak projekata</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="">Spisak obrisanih projekata</a>
        </li>
        <li class="nav-item">
...
<section id="obrisaniPostovi">
    <div class="card col-lg-9">
        <div class="card-header">Spisak obrisanih projekata</div>
        <div class="card-body">
            <!-- Tabela -->
            <table class="tabela-admin table table-hover">
                <thead>
...
<section id="unosPostova">
    <div class="card col-lg-12">
        <div class="card-header">Unos novog projekta</div>
        <div class="card-body">
            <form action="http://localhost:8000/admin/posts" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="podnaslov">Naslov</label>
                    <input type="text" name="podnaslov" class="form-control">
                </div>
                <div class="form-group">
                    <label for="sadrzaj">Sadržaj projekta</label>
                    <textarea class="form-control textarea-autosize" placeholder="Ovde treba ubaciti sadrzaj projekta" style="overflow: hidden; word-wrap: break-word; height: 81px;" id="summernote" name="sadrzaj"></textarea>
                </div>
                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="select">
                                <select class="form-control select_custom">
                                    ...
                                    <option value="3">BackEnd+FronEnd</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="linkProjekta" class="form-control">
                </div>
                <div class="form-group">
                    <label for="linkGitHuba">linkGitHuba</label>
                    <input type="text" name="linkGitHuba" class="form-control">
                </div>
                <div class="form-group">
    ...
    <div class="card col-lg-9">
        ...
        <div class="card-body">
            <form action="#" method="post" >
                <!-- hidden polje -->
                <div class="form-group">
                    <label for="tag">Ime taga</label>
                    <input type="text" name="tag" class="form-control">
                </div>
                <div class="form-group">
                    <label for="funkcionalnost_id">Ime taga</label>
                    <input type="text" name="funkcionalnost_id" class="form-control">
                </div>
                <div class="form-group">
                    <label for="tehnologije_id">Ime taga</label>
                    <input type="text" name="tehnologije_id" class="form-control">
                </div>
                <div class="form-group">
                    <label for="biblioteke_id">Ime taga</label>
                    <input type="text" name="biblioteke_id" class="form-control">
                </div>
