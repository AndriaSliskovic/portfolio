            ...
            <div class="card-body">
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                        <input type="text" class="form-control input-sm" placeholder="Naziv taga" name="tag" value="{{old('tag')}}">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control input-sm" placeholder="opis taga" name="opis" value="{{old('opis')}}">
                        <i class="form-group__bar"></i>
                    </div>
                    <div class="form-group">
