@extends('layouts.testIndex')
<!-- Contents -->
@section('default')
    <div class="content">
    <h3>Ovo je defaultni sadrzaj</h3>
    </div>
    @endsection
@section('naslov')
    <div class="content">
...
@section('sviPostovi')
<section id="sviPostovi" class="content">
    <!-- Kartica -->
...
@section('obrisaniPostovi')
        <section id="obrisaniPostovi" class="content">
            <!-- Kartica -->
...
@endsection
@section('unosPostova')
<section id="unosPostova" class="content">
    <!-- FormaZaUnosPostova -->
    <div class="card col-lg-12">
...
<section id="napraviNovuKategoriju" class="content">
    <div class="card col-lg-9">
...
<section id="spisakKategorija" class="content">
    <div class="card col-lg-9">
...
<!-- NapraviTag -->
@section('napraviTag')
<section id="napraviTag" class="content">
    <div class="card col-lg-9">
...
<!-- PromeniTag -->
@section('promeniTag')
<section id="promeniTag" class="content">
    <div class="card col-lg-9">
...
<section id="promeniUsera" class="content">
    <div class="card col-lg-9">
...
<!-- UnesiUsera -->
@section('unesiUsera')
<section id="unesiUsera" class="content">
    <div class="card col-lg-9">
